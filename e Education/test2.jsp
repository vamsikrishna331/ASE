<html><body><script>alert("Your Test1 is Completed.. This is Test2");</script>
...
<tr><td><h2>&nbsp;&nbsp;<font size="" color="#6699ff">Write Correct Answer for following </table>
...
<td>	<input type="text" name="<%=rs.getString(1)%>" required >			
